...
/**
 * Initialize the CPU, peripherals and the system-level state machine.
 */
void System_init(void);

/**
 * Runs the system-level state machine. Must be called from the main loop.
 * @return Result of the last state transition.
 */
